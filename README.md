...
- **Lighthouse CI** — [Lighthouse CI](https://github.com/GoogleChrome/lighthouse-ci) runs a single Lighthouse audit (performance, accessibility, best practices, SEO) against the served site and asserts minimum scores (see `lighthouserc.js`).
